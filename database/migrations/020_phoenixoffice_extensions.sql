-- 020_phoenixoffice_extensions.sql
-- Idempotent PhoenixOffice/PhoenixWrite extension migration.
...
CREATE INDEX IF NOT EXISTS idx_routing_event_source ON etos.routing_event(source_module_id);
CREATE INDEX IF NOT EXISTS idx_routing_event_target ON etos.routing_event(target_module_id);
